...
const PROJECTS: Project[] = [
  ...
  { id: 203, cat: "websites", title: "Dévotion Skin", desc: "Cosmética biológica em Marketing Multi-nível.", result: "+253% novos distribuidores", color: "from-yellow-600 to-stone-900", image: portfolioDevotionSkin, link: "https://devotionskin.com" },
  ...
  { id: 10, cat: "websites", title: "Happy Yellow", desc: "Eventos, Show e Agenciamento.", result: "+347% visibilidade online", color: "from-yellow-400 to-amber-500", image: portfolioHappyYellow, link: "https://happy-yellow.com/" },
  { id: 11, cat: "websites", title: "Estofos Korban", desc: "Estofamento de Luxo para Iates.", result: "+218% pedidos de orçamento", color: "from-sky-500 to-blue-600", image: portfolioEstofosKorban, link: "https://estofoskorban.com/" },
  { id: 12, cat: "websites", title: "Elétrica Cunha Soluções", desc: "Serviços de elétrica.", result: "+187% pedidos online", color: "from-orange-500 to-amber-600", image: portfolioEletricaCunha, link: "https://eletricacunhasolucoes.com/" },
  { id: 13, cat: "websites", title: "Diamante Dourado", desc: "Imobiliária.", result: "+389% leads qualificados", color: "from-yellow-600 to-amber-700", image: portfolioDiamanteDourado, link: "https://diamantedourado.com.pt/" },
  { id: 14, cat: "websites", title: "Astrólogo Manuel Jacinto", desc: "Astrologia e Tarot.", result: "+263% consultas agendadas", color: "from-violet-600 to-purple-700", image: portfolioManuelJacinto, link: "https://astrologomanueljacinto.com/" },
  { id: 15, cat: "websites", title: "Cutelaria Arte Afiada", desc: "Cutelaria e Facas Especiais.", result: "+291% vendas online", color: "from-stone-600 to-amber-700", image: portfolioArteAfiada, link: "https://arteafiada.com/" },
  { id: 16, cat: "websites", title: "Africanoa", desc: "Viagens, Turismo e Exportação.", result: "+314% reservas online", color: "from-green-600 to-emerald-500", image: portfolioAfricanoa, link: "https://africanoa.com/" },
  { id: 17, cat: "websites", title: "WS Obras", desc: "Obras e Remodelações.", result: "+237% pedidos de orçamento", color: "from-red-500 to-rose-600", image: portfolioWsObras, link: "https://ws-obras.com/" },
  { id: 18, cat: "websites", title: "Jasa Serviços", desc: "Mudanças em Geral.", result: "+194% contactos online", color: "from-red-600 to-gray-700", image: portfolioJasaServicos, link: "https://jasaservicos.effectidea.com/" },
  { id: 19, cat: "websites", title: "My Portail Tech", desc: "Automações de Portões.", result: "+271% pedidos online", color: "from-orange-500 to-yellow-500", image: portfolioMyPortailTech, link: "https://myportailtech.com/" },
  { id: 20, cat: "websites", title: "Elli Hair", desc: "Produtos para Cabelos Especiais.", result: "+336% vendas online", color: "from-yellow-700 to-amber-800", image: portfolioElliHair, link: "https://lp.ellihair.com/" },
  { id: 21, cat: "websites", title: "Tons de Pele", desc: "Vestuário Íntimo Feminino.", result: "+374% vendas online", color: "from-rose-700 to-red-800", image: portfolioTonsDePele, link: "https://tonsdepele.com/" },
  { id: 22, cat: "websites", title: "Ozone 7 Real Estate", desc: "Imobiliária.", result: "+348% leads qualificados", color: "from-amber-500 to-yellow-600", image: portfolioOzone7, link: "https://ozone7realestate.com/" },
  ...
  { id: 34, cat: "websites", title: "Marisol Travel", desc: "Viagens e Turismo.", result: "+347% reservas online", color: "from-rose-500 to-pink-500", image: portfolioMarisolTravel, link: "https://marisoltravel.com/" },
  { id: 35, cat: "websites", title: "Oficina Souza Car", desc: "Oficina Mecânica.", result: "+276% agendamentos online", color: "from-emerald-500 to-teal-500", image: portfolioSouzaCar, link: "https://oficinasouzacar.com/" },
  { id: 36, cat: "websites", title: "Femme Skin", desc: "Estética e Massagens.", result: "+319% agendamentos online", color: "from-purple-500 to-indigo-500", image: portfolioFemmeSkin, link: "https://femme.skin/" },
  { id: 37, cat: "websites", title: "João Santos Imobiliária", desc: "Imobiliária.", result: "+354% leads qualificados", color: "from-amber-500 to-yellow-500", image: portfolioJoaoSantos, link: "https://joaosantosimobiliaria.com/" },
  { id: 38, cat: "websites", title: "Indian Palace Tandoori", desc: "Restaurante Indiano.", result: "+287% reservas online", color: "from-red-500 to-orange-500", image: portfolioIndianPalace, link: "https://indianpalacetandoori.com/" },
  { id: 39, cat: "websites", title: "Lemos Beauty Home", desc: "Estética, Massagens e Maquiagem.", result: "+326% agendamentos online", color: "from-sky-500 to-cyan-500", image: portfolioLemosBeauty, link: "https://lemosbeautyhome.com/" },
